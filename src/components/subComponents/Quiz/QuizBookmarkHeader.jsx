            ...
            <div className="col-lg-6">
              <div className="row align-items-center">
                <div className="col-lg-3 my-2">
                  <form className="difficulty-level-form">
                ...
                <div className="col-lg-5">
                  ...
                  {showSubmit ? (
                    ...
                    generateQuestionBtn === "Generate Questions" || aiQuestionAnswer ?
                      <button
                        type="button"
                ...
                {/* <div className="col-lg-4">
                  <div className="dropdown prepy">
                    ...
                    <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                      {chapterHistory.revision_no_arr.length === 0 ? (
                        <li value="" className="no-history" disabled><a>
                          No History Found
                        </a></li>
                      ) : (
                        chapterHistory.revision_no_arr.map((revision, index) => {
...
export default QuizBookmarkHeader;
